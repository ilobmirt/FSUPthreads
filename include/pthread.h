...
extern int pthread_create               _C_PROTOTYPE((pthread_t *_thread,
                                                      pthread_attr_t *__attr,
                                                      pthread_func_t __func,
                                                      any_t __arg));
extern int pthread_equal                _C_PROTOTYPE((pthread_t __t1,
                                                      pthread_t __t2));
extern int pthread_detach               _C_PROTOTYPE((pthread_t _thread));
extern int pthread_join                 _C_PROTOTYPE((pthread_t _thread,
                                                      any_t *__status));
...
extern int pthread_getschedparam        _C_PROTOTYPE((pthread_t _thread,
						      int *__policy,
                                                      struct sched_param *__param));
extern int pthread_setschedparam        _C_PROTOTYPE((pthread_t _thread,
						      int __policy,
                                                      struct sched_param *__param));
...
extern int pthread_kill        _C_PROTOTYPE((pthread_t _thread,
                                             int __sig));
extern int pthread_cancel      _C_PROTOTYPE((pthread_t _thread));
